  ...
  <div style="max-width:600px;margin:0 auto;">
    ...
    <table style="width:100%;border-collapse:collapse;margin-bottom:16px;">
      <tr>
        ...
        <td style="padding:8px 0;border-bottom:1px solid #e5e7eb;">${safeActor}</td>
      </tr>
    </table>
    <a href="${safeUrl}" style="display:inline-block;background:#22c55e;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-weight:600;">View alert →</a>
  </div>
</body>
</html>`;
